...
fh.write('import paramsearchGA_DopDep_nonlinear_GSSO as psGA\n')
fh.write('delay = 1.0\n')
...
'#SBATCH --output=/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/newParams/strictHealthy/output/test1_PDF_%s.out'%(sim_name),
'#SBATCH --error=/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/newParams/strictHealthy/output/test1_PDF_%s.err'%(sim_name),
#'#PBS -j oe\n',
'#SBATCH --job-name=%s\n'%(sim_name),
...
'python /home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/newParams/strictHealthy/GA/%s_.py\n'%(sim_name),
