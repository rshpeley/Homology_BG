...
def paramSearch(d):
	...
	for epoch in xrange(4000):
		...
		for i,ind in enumerate(elmt):
			...
			if np.mean(SWARates['d1'][1000:]) > 1.0 and np.mean(SWARates['d2'][100./p.params["dt"]:]) > 0.1 and np.mean(SWARates['fsi'][1000:]) > 0.1 and 			np.mean(SWARates['ta'][1000:]) > 0.5 and np.mean(SWARates['ti'][1000:]) > 0.5 and np.mean(SWARates['stn'][1000:]) > 0.5 and np.mean(SWARates['gpi'][100./p.params["dt"]:]) > 0.1:
				tests[6] = 1
