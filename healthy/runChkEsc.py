...
for ip in ctxinp:
	...
	'#SBATCH --output=/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/strictHealthy/output/chkEs_%s.out'%(sim_name),
	'#SBATCH --error=/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/strictHealthy/output/chkEs_%s.err'%(sim_name),
	#'#PBS -j oe\n',
	'#SBATCH --job-name=%s\n'%(sim_name),
