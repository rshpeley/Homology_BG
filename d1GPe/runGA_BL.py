...
fh.write('import sys\n')
fh.write("sys.path.insert(0,'/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/newParams/forReview/d1GPe/')\n")
...
'#SBATCH --output=/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/newParams/forReview/d1GPe/output/test_PDF_%s.out'%(sim_name),
'#SBATCH --error=/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/newParams/forReview/d1GPe/output/test_PDF_%s.err'%(sim_name),
#'#PBS -j oe\n',
'#SBATCH --job-name=%s\n'%(sim_name),
...
'python /home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/newParams/forReview/d1GPe/GA/%s_.py\n'%(sim_name),
