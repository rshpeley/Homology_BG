...
def run(prefix,pars):
	...
	for d1ta1,d2ta1,fsita1,fsiti1,tata1,tati1,tastn1,tita1,titi1,tistn1,stnti1,tid21,tad21,jc11,jc21,jfsictx1,jstnctx1,stnta1,d1ti1,d2ti1 in zip(d1taDist,d2taDist,fsitaDist,fsitiDist,tataDist,tatiDist,tastnDist,titaDist,titiDist,tistnDist,stntiDist,tid2Dist,tad2Dist,jc1Dist,jc2Dist,jfsictxDist,jstnctxDist,stntaDist,d1tiDist,d2tiDist):
		if np.abs(d1ti1) > np.abs(d1ta1)/1.5  or np.abs(d2ti1) > np.abs(d2ta1)/1.5 or np.abs(tid21) > 1 or np.abs(tad21) > 1 or np.abs(stnta1) > np.abs(stnti1)/2. or np.abs(fsita1) > np.abs(fsiti1)/1.5 or np.abs(d1ta1) > np.abs(d2ta1): #or np.abs(jc21) > np.abs(jc11) : # or  # Try to restrict tid2 /tad2 to low values
			continue	
	...
	if np.abs(d1ti)*1.5 <  np.abs(d1ta)  and np.abs(d2ti)*1.5 < np.abs(d2ta)  and np.abs(tid2) < 1 and np.abs(tad2) < 1. and np.abs(stnta1)*2. < np.abs(stnti1) and np.abs(fsita)*1.5 < np.abs(fsiti) and np.abs(d2ta) > np.abs(d1ta):# and np.abs(jc1) > np.abs(jc2)*1.2 :    # and np.abs(jc1) >1.0*np.abs(jc2) :# This is the 1 1for all corase options so it always fails or np.abs(stnta1) > np.abs(stnti1)/1.5: 
	...
	for d1ta1,d2ta1,fsita1,fsiti1,tata1,tati1,tastn1,tita1,titi1,tistn1,stnti1,tid21,tad21,jc11,jc21,jfsictx1,jstnctx1,stnta1,d1ti1,d2ti1 in zip(d1taDist,d2taDist,fsitaDist,fsitiDist,tataDist,tatiDist,tastnDist,titaDist,titiDist,tistnDist,stntiDist,tid2Dist,tad2Dist,jc1Dist,jc2Dist,jfsictxDist,jstnctxDist,stntaDist,d1tiDist,d2tiDist):
		if np.abs(d1ti1) > np.abs(d1ta1)/1.5  or np.abs(d2ti1) > np.abs(d2ta1)/1.5 or np.abs(tid21) > 1 or np.abs(tad21) > 1. or np.abs(stnta1) > np.abs(stnti1)/2. or np.abs(fsita1) > np.abs(fsiti1)/1.5 or np.abs(d1ta1) > np.abs(d2ta1):# or np.abs(jc21) > np.abs(jc11) : #np.abs(stnta1) > np.abs(stnti1)/1.2 or  # Try to restrict tid2 /tad2 to low values
			continue	
		#if np.abs(jc11) > np.abs(jc21)*1.2:
		iter1+=1
		A = np.matrix([[knownparams['d1d1'],knownparams['d1d2'],knownparams['d1fsi'],d1ta1,d1ti1,0.,0.],[knownparams['d2d1'],knownparams['d2d2'],knownparams['d2fsi'],d2ta1,d2ti1,0.,0.],[0.,0.,knownparams['fsifsi'],fsita1,fsiti1,0.,0.],[0,tad21,0.,tata1,tati1,tastn1,0],[0.,tid21,0.,tita1,titi1,tistn1,0.],[0.,0.,0.,stnta1,stnti1,knownparams['stnstn'],0.],[knownparams['gpid1'],0.,0.,knownparams['gpita'],knownparams['gpiti'],knownparams['gpistn'],knownparams['gpigpi']]])
