...
AllBsPD = pickle.load(open(pathname+"AllBsPDShuff.pickle","r"))
clusPDShuff = pickle.load(open(pathname+"clusPDShuff.pickle","r"))

AllAsH = pickle.load(open(pathname1+"AllAsHShuff.pickle","r"))
AllBsH = pickle.load(open(pathname1+"AllBsHShuff.pickle","r"))
clusHShuff = pickle.load(open(pathname1+"clusHShuff.pickle","r"))
# RobustPathological
...
pickle.dump(CVValInfo,open(pathname+"CVValInfoShuff.pickle","w"))
randSampsPD = pickle.load(open(pathname+"randSampsPD.pickle","r"))
#randSampsH = pickle.load(open(pathname1+"randSampsH.pickle","r"))
randSampsH = pickle.load(open(pathname1+"randSampsH1.pickle","r"))
seed1 = pickle.load(open(pathname+"Seeds.pickle","r"))[0]
forReplaceInc = pickle.load(open(pathname+"forReplaceIncSep.pickle","r"))
curr_ind = 0
for i in xrange(1,21):
	for grps in np.arange(0,10,1) : # 10 groups
		# Calculate 
		params = dict()
		params["idPD"] = 4
		params["idH"] = 0
		params["start"] = grps*100 # 10 groups of 100 each
		params["end"] = grps*100+100
		...
		params["seed"] = seed1 
		sim_name ="replaceHists_Mean_Parts_"+str(seed1)+"_"+"cumTermsNo"+str(i)+"grp_"+str(grps)
		...
		fh.write('import replaceHistsByMeansIncMeanParts as rHBM\n')
