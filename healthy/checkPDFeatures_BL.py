...
#		PDFeatures[i][1] = np.var(TransRates['gpi'][1100:2400])/np.mean(TransRates['gpi'][1100:2400]) 
	...
	#	TransRatesSTP['ti'][502/dt:1400/dt] += noise
		...
		if i%250==0:
			pickle.dump(PDFeatures,open(pathname+"PDFeaturesnew_BL_"+str(ipAmp)+"_"+str(i)+".pickle","w"))			
			#pickle.dump(randSamps,open(pathname+"randSampsnew.pickle","w"))
			if ipAmp == 0 or ipAmp == 5:
				pickle.dump(AllAs,open(pathname+"AllAs_BL"+str(ipAmp)+".pickle","w"))
			#	pickle.dump(AllASTPs,open(pathname+"AllASTPs.pickle","w"))
				pickle.dump(AllBs,open(pathname+"AllBs_BL"+str(ipAmp)+".pickle","w"))
	...
	pickle.dump(baseLineFR,open(pathname+"baseLineFR_BL"+str(ipAmp)+".pickle","w"))
	pickle.dump(PDFeatures,open(pathname+"PDFeaturesnew_BL"+str(ipAmp)+".pickle","w"))
