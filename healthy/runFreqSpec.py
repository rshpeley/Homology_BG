...
storage_home = '/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/strictHealthy'
...
clusterIndsH = pickle.load(open(path5+"clustersH5.pickle","r"))
for i,clusH in enumerate(clusterIndsH):
	if len(clusH) > 0 :
		print i
		...
		params["clusH"] = clusH	
		params["i"] = i
		sim_name = "freqSpecH_"+str(i)
		
		fh = open(path3 + '%s.py'%(sim_name),'w')
		fh.write('import sys\n')
		fh.write("sys.path.insert(0,'/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/strictHealthy/')\n")
		...
		'#SBATCH --output=/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/strictHealthy/output/FS_%s.out'%(sim_name),
		'#SBATCH --error=/home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/strictHealthy/output/FS_%s.err'%(sim_name),
		#'#PBS -j oe\n',
		'#SBATCH --job-name=%s\n'%(sim_name),
		...
		'python /home/j.bahuguna/homology/Mallet/wojc1jc2/slowNormParams/strictHealthy/jdf/%s.py\n'%(sim_name),
